    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type_of_query', models.CharField(choices=[('PATIENT', 'FHIR Patient'), ('ENCOUNTER', 'FHIR Encounter')], default='PATIENT',
                                                        max_length=9)),
                ...
                ('shared_by', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shared_requests',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perimeters_ids', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=15), blank=True, null=True,
                                                                             size=None)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_request_query_snapshots',
                                            to=settings.AUTH_USER_MODEL)),
                ('previous_snapshot', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='next_snapshots',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_job_status', models.CharField(choices=[('new', 'new'), ('denied', 'denied'), ('validated', 'validated'),
                                                                 ...
                                                                 ('cleaned', 'cleaned'), ('unknown', 'unknown')], default='started', max_length=15,
                                                        null=True)),
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_request_query_results',
                                            to=settings.AUTH_USER_MODEL)),
                ('request_query_snapshot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dated_measures',
                                                             to='cohort.requestquerysnapshot')),
            ],
            options={
                'abstract': False,
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('IMPORT_I2B2', 'Previous cohorts imported from i2b2.'),
                                                   ('MY_ORGANIZATIONS', 'Organizations in which I work '
                                                                        '(care sites with pseudo-anonymised reading rights).'),
                                                   ('MY_PATIENTS', 'Patients that passed by all my organizations (care sites with'
                                                                   ' nominative reading rights).'), ('MY_COHORTS', 'Cohorts I created in Cohort360')],
                ...
                ('dated_measure_global', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='restricted_cohort',
                ...
                ('request_query_snapshot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cohort_results',
                                                             to='cohort.requestquerysnapshot')),
            ],
            options={
                'abstract': False,
