# Generated by Django 2.2.16 on 2022-01-19 16:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perimeters_ids', django.contrib.postgres.fields.ArrayField(
                    base_field=models.CharField(max_length=15), blank=True,
                    null=True, size=None)),
                ('owner', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measure_male', models.BigIntegerField(blank=True, null=True)),
                ('measure_unknown', models.BigIntegerField(blank=True,
                                                           null=True)),
                ('measure_deceased', models.BigIntegerField(blank=True,
                                                            null=True)),
                ('measure_alive', models.BigIntegerField(blank=True,
                                                         null=True)),
                ('measure_female', models.BigIntegerField(blank=True,
                                                          null=True)),
                ('count_task_id', models.TextField(blank=True)),
                ('request_job_id', models.TextField(blank=True)),
                ('request_job_status', models.CharField(
                    choices=[('killed', 'killed'), ('finished', 'finished'),
                ...
                ('mode', models.CharField(
                    choices=[('Snapshot', 'Snapshot'), ('Global', 'Global')],
                    default='Snapshot', max_length=20, null=True)),
                ('owner', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(
                    choices=[('IMPORT_I2B2',
                              'Previous cohorts imported from i2b2.'),
                             ('MY_ORGANIZATIONS',
                              'Organizations in which I work (care sites with '
                              'pseudo-anonymised reading rights).'),
                             ('MY_PATIENTS',
                              'Patients that passed by all my organizations '
                ...
                ('dated_measure', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    related_name='cohort', to='cohort.DatedMeasure')),
                ('dated_measure_global', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL,
                    related_name='restricted_cohort',
