...
def send_email_notif_about_shared_request(request_name: str, owner: User, recipient: User) -> None:
    ...
    email_notif = EmailNotification(
        subject=subject, to=[recipient.email], html_template="shared_request.html", txt_template="shared_request.txt", context=context
    )
    email_notif.push()
...
def send_email_notif_feasibility_report_requested(request_name: str, owner: User) -> None:
    ...
    context = {**BASE_CONTEXT, "recipient_name": owner.display_name, "request_name": request_name}
    email_notif = EmailNotification(
        subject=subject,
        to=[owner.email],
...
def send_email_notif_feasibility_report_ready(request_name: str, owner: User, fs_id: str) -> None:
    ...
    email_notif = EmailNotification(
        subject=subject, to=[owner.email], html_template="feasibility_report_ready.html", txt_template="feasibility_report_ready.txt", context=context
    )
    email_notif.push()
...
def send_email_notif_error_feasibility_report(request_name: str, owner: User) -> None:
    ...
    email_notif = EmailNotification(
        subject=subject, to=[owner.email], html_template="feasibility_report_error.html", txt_template="feasibility_report_error.txt", context=context
    )
    email_notif.push()
...
def send_email_notif_count_request_refreshed(request_name: str, owner: User) -> None:
    ...
    email_notif = EmailNotification(
        subject=subject, to=[owner.email], html_template="count_request_refreshed.html", txt_template="count_request_refreshed.txt", context=context
    )
    email_notif.push()
