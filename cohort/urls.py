...
from cohort.views import RequestViewSet, RequestQuerySnapshotViewSet, \
    CohortResultViewSet, DatedMeasureViewSet, FolderViewSet, \
...
router.register(r'dated-measures',
                DatedMeasureViewSet, basename="dated-measures")
