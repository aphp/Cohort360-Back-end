...
folder_router.register("requests", NestedRequestViewSet, basename="folder-requests", parents_query_lookups=["parent_folder"])

req_router = router.register(r"requests", RequestViewSet, basename="requests")
req_router.register("query-snapshots", NestedRqsViewSet, basename="request-request-query-snapshots", parents_query_lookups=["request_id"])

rqs_router = router.register(r"request-query-snapshots", RequestQuerySnapshotViewSet)
rqs_router.register("next-snapshots", NestedRqsViewSet, basename="request-query-snapshot-next-snapshots", parents_query_lookups=["previous_snapshot"])
