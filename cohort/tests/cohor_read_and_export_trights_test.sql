...
VALUES (-10, 'READ_ALL', 'f', 'f', 'f', 't', 't', 'f', 'f', 'f', 'f', 'f', 'f', 't', 'f', 't', 'f', 'f', 'f',
...
INSERT INTO accesses_role (id, name, right_full_admin, right_manage_users, right_read_users,
                           ...
                           right_transfer_jupyter_nominative, right_transfer_jupyter_pseudo_anonymised,
                           right_manage_datalabs, right_read_datalabs)
VALUES (-11, 'READ_ONLY_NOMINATIVE', 'f', 'f', 'f', 't', 't', 'f', 'f', 'f', 'f', 'f', 'f', 't', 'f', 'f', 'f',
        'f', 'f',
        'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f');
...
INSERT INTO accesses_role (id, name, right_full_admin, right_manage_users, right_read_users,
                           ...
                           right_transfer_jupyter_nominative, right_transfer_jupyter_pseudo_anonymised,
                           right_manage_datalabs, right_read_datalabs)
VALUES (-12, 'READ_ONLY_PSEUDO', 'f', 'f', 'f', 't', 't', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 't', 'f', 'f',
        'f',
        'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f');
...
INSERT INTO accesses_role (id, name, right_full_admin, right_manage_users, right_read_users,
                           ...
                           right_transfer_jupyter_nominative, right_transfer_jupyter_pseudo_anonymised,
                           right_manage_datalabs, right_read_datalabs)
VALUES (-21, 'EXPORT_NOMI', 'f', 'f', 'f', 't', 't', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f',
...
INSERT INTO accesses_role (id, name, right_full_admin, right_manage_users, right_read_users,
                           ...
                           right_transfer_jupyter_nominative, right_transfer_jupyter_pseudo_anonymised,
                           right_manage_datalabs, right_read_datalabs)
VALUES (-22, 'EXPORT_PSEUDO', 'f', 'f', 'f', 't', 't', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f',
...
INSERT INTO accesses_role (id, name, right_full_admin, right_manage_users, right_read_users,
                           ...
                           right_transfer_jupyter_nominative, right_transfer_jupyter_pseudo_anonymised,
                           right_manage_datalabs, right_read_datalabs)
VALUES (-32, 'TRANSFER_PSEUDO', 'f', 'f', 'f', 't', 't', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f',
...
INSERT INTO accesses_role (id, name, right_full_admin, right_manage_users, right_read_users,
                           ...
                           right_transfer_jupyter_nominative, right_transfer_jupyter_pseudo_anonymised,
                           right_manage_datalabs, right_read_datalabs)
VALUES (-31, 'TRANSFER_NOMI', 'f', 'f', 'f', 't', 't', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 'f',
...
INSERT INTO accesses_role (id, name, right_full_admin, right_manage_users, right_read_users,
                           ...
                           right_transfer_jupyter_nominative, right_transfer_jupyter_pseudo_anonymised,
                           right_manage_datalabs, right_read_datalabs)
VALUES (-99, 'TRANSFER_NOMI', 'f', 'f', 'f', 't', 't', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 't', 'f', 'f', 'f',
