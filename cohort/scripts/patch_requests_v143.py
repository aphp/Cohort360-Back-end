...
from cohort.scripts.patch_requests_v142 import NEW_VERSION as PREV_VERSION_3
...
def find_related_atc(code: str):
    if code.startswith("undefined|"):
        ...
        return find_related_atc_v140(code_value[1])
    return code
...
updater_v143 = QueryRequestUpdater(
    ...
    previous_version_name=[PREV_VERSION, PREV_VERSION_2, PREV_VERSION_3],
