...
concepts_data = [
    {"source_concept_id": 1, "source_concept_name": "Care site"},
    {"source_concept_id": 2, "source_concept_name": "Care Site is part of Care Site"},
]

lists_data = [
    ["id", "size", "source_reference_id", "source_type", "delete_datetime"],
    [
...
care_sites_data = [
    ["care_site_id", "care_site_name", "care_site_short_name", "care_site_source_value", "care_site_type_source_value", "delete_datetime"],
    [
...
fact_rels_data = [
    ["row_id", "fact_id_1", "fact_id_2", "domain_concept_id_1", "domain_concept_id_2", "relationship_concept_id"],
    [
...
users_data = [{"username": "1", "email": "user1@example.com", "firstname": "User", "lastname": "One"}]

folders_data = [{"name": "Folder 1", "owner_id": 1}]

requests_data = [{"owner_id": 1, "name": "Request 1", "description": "Description for Request 1", "favorite": False, "shared_by_id": None}]
