...
class CohortCreatorTest(BaseTest):
    def setUp(self):
        ...
        self.cohort = CohortResult.objects.create(request_query_snapshot=self.snapshot, dated_measure=self.dm, owner=self.user)
    ...
    def test_successfully_handle_patch_cohort(self):
        ...
        patch_data = {"request_job_status": "FINISHED", "group.id": group_id, "group.count": group_count}
    ...
    def test_handle_patch_cohort_invalid_status(self):
        patch_data = {"request_job_status": "WRONG_STATUS", "group.id": "12345"}
