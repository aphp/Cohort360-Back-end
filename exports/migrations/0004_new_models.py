    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'En attente'), ('SENT_TO_DE', 'Envoyé au DataExporter'), ('DELIVERED', 'Livré')], max_length=20)),
                ...
                ('shift_dates', models.BooleanField()),
                ('is_user_notified', models.BooleanField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=55)),
                ('type', models.CharField(choices=[('INT', 'Integer'), ('TXT', 'Text'), ('SIZE_BYTES', 'Size Bytes')], max_length=20)),
