    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cohort_fk', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='export_requests', to='cohort.cohortresult')),
                ('creator_fk', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_export_requests', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='export_requests', to=settings.AUTH_USER_MODEL)),
                ('reviewer_fk', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reviewed_export_requests', to=settings.AUTH_USER_MODEL)),
                ('target_unix_account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='export_requests', to='workspaces.account')),
            ],
            options={
