...
# REGEX
USERNAME_REGEX = env.str("USERNAME_REGEX", default=r"(.*)")
...
IDENTITY_SERVER_AUTH_ENDPOINT = env.str("IDENTITY_SERVER_AUTH_ENDPOINT", default="")
IDENTITY_SERVER_USER_INFO_ENDPOINT = env.str("IDENTITY_SERVER_USER_INFO_ENDPOINT", default="")
IDENTITY_SERVER_AUTH_HEADER = env.str("IDENTITY_SERVER_AUTH_HEADER", default="Authorization")
IDENTITY_SERVER_AUTH_TOKEN = env.str("IDENTITY_SERVER_AUTH_TOKEN", default="")
IDENTITY_SERVER_HEADERS = {IDENTITY_SERVER_AUTH_HEADER: IDENTITY_SERVER_AUTH_TOKEN}
