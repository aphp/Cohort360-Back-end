...
class ExportersConfig(AppConfig):
    ...
    EXPORTERS = [
        {"TYPE": ExportTypes.CSV.value, "EXPORTER_CLASS": "exporters.exporters.csv_exporter.CSVExporter"},
        {"TYPE": ExportTypes.XLSX.value, "EXPORTER_CLASS": "exporters.exporters.xlsx_exporter.XLSXExporter"},
        {"TYPE": ExportTypes.HIVE.value, "EXPORTER_CLASS": "exporters.exporters.hive_exporter.HiveExporter"},
    ]
