...
from workspaces.views import AccountViewset, ProjectViewset, JupyterMachineViewset, RangerHivePolicyViewset, \
                             LdapGroupViewset, KernelViewset

router = routers.DefaultRouter()
router.register(r'projects', ProjectViewset, basename="projects")
# TODO: Ask to change route call in portail front: workspaces/users to workspaces/accounts
