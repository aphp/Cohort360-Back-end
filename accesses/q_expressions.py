...
q_allow_export_csv_nominative = Q(role__right_export_csv_nominative=True)
q_allow_export_jupyter_nominative = Q(role__right_export_jupyter_nominative=True)
q_allow_export_csv_pseudo = join_qs([Q(role__right_export_csv_nominative=True),
...
q_allow_manage_export_accesses = join_qs([Q(role__right_manage_export_csv_accesses=True),
