...
right_read_patient_nominative = Right(
    "right_read_patient_nominative", impact_lower_levels=True)
right_read_patient_pseudo_anonymised = Right(
    "right_read_patient_pseudo_anonymised", impact_lower_levels=True)
right_search_patient_with_ipp = Right(
    "right_search_patient_with_ipp", impact_lower_levels=True)
...
jup_review_manage_rights = RightGroup(
    name="jup_review_manage_rights", rights=[
        right_manage_review_transfer_jupyter,
...
csv_review_manage_rights = RightGroup(
    name="csv_review_manage_rights", rights=[
        right_manage_review_export_csv,
    ], description="Manage accesses allowing to review Jupyter exports",
...
jup_export_manage_rights = RightGroup(
    name="jup_export_manage_rights", rights=[
        right_manage_transfer_jupyter,
...
csv_export_manage_rights = RightGroup(
    name="csv_export_manage_rights", rights=[
        right_manage_export_csv,
    ], description="Manage accesses allowing to make exports",
...
main_admin_rights = RightGroup(
    name="main_admin_rights", rights=[
        right_edit_roles,
...
any_admin_manager_rights = RightGroup(
    name="main_admin_rights",
    rights=[right_read_users],
