...
- [x] As a user with right_full_admin, I can create a role
- [x] As a user with everything but right_full_admin, I cannot create a role

#### PATCH

- [x] As a user with right_full_admin, I can edit a role
- [x] As a user with everything but right_full_admin, I cannot edit a role
